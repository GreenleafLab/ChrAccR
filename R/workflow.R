...
run_atac_sc_unsupervised <- function(dsa, anaDir){
	...
	if (doUnsupervised){
		...
		logger.start("Iterative LSI")
			...
			itLsi <- iterativeLSI(dsan, it0regionType=itLsiRt, it0clusterResolution=clustRes, it1clusterResolution=clustRes, it2clusterResolution=clustRes, umapParams=umapParams)
		logger.completed()
